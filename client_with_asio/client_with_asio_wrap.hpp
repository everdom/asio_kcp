...
class client_with_asio_wrap
  : private boost::noncopyable
{
public:
    client_with_asio_wrap(boost::asio::io_service& io_service, int udp_port_bind,
...
private:
  ...
  static void client_event_callback_func(kcp_conv_t conv, asio_kcp::eEventType event_type, kcp_buffer_data& msg, void* var);
  void handle_client_event_callback(kcp_conv_t conv, asio_kcp::eEventType event_type, kcp_buffer_data& msg);

    asio_kcp::kcp_client_wrap kcp_client_wrap_;
